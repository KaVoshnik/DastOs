...
USERMODE64_ASM = $(SRC_DIR)/kernel/usermode64.asm
OBJECTS64 += $(BUILD_DIR)/usermode64.o
...
$(BUILD_DIR)/usermode64.o: $(USERMODE64_ASM) | $(BUILD_DIR)
	$(AS) -f elf64 $(USERMODE64_ASM) -o $(BUILD_DIR)/usermode64.o
